  ...
  return (
    <div className="page usw">
      ...
      <main className="usw-main">
        ...
        <footer className="usw-footer">
          <div className="usw-footer__inner">
            <div className="usw-footer__brand">
              <div className="usw-footer__logo">GEMEPAD.FUN</div>
              <div className="usw-footer__desc">
                Lorem ipsum dolor sit amet consectetur. Neque dolor non amet ullamcorper nullam nunc in diam.
              </div>
            </div>
            <div className="usw-footer__cols">
              <div className="usw-footer__col">
                <div className="usw-footer__head">Sections</div>
                <a href="#">Home</a>
              ...
              <div className="usw-footer__col">
                <div className="usw-footer__head">Company</div>
                <a href="#">About</a>
                <a href="#">Careers</a>
                <a href="#">Contact</a>
              </div>
            </div>
            <div className="usw-footer__bottom">
              <div>© 2010-2025 GamePadFun. All rights reserved</div>
              <div className="usw-footer__bottom-links">
      ...
      <style jsx>{`
        ...
        .usw-footer__bottom-links {
          display: flex;
          gap: 16px;
          flex-wrap: wrap;
        }
        .usw-footer__bottom-links a {
          color: rgba(255, 255, 255, 0.5);
          text-decoration: none;
          font-size: 12px;
        }
        .usw-footer__bottom-links a:hover {
          color: #fff;
        }
