...
const worldsData = [
  {
    ...
    title: "GENERAL WORLD",
    description:
      "Lorem ipsum dolor sit amet consectetur. Pulvinar egestas nec et egestas eu odio amet iaculis auctor. Rutrum sit aliquam id ia",
    color: "#FFFFFF",
    image: generalWorld,
  },
  {
    ...
    <div className="page explore-page">
      <div className="page__bg-container">
        <img
          src={bg01}
          alt=""
          className="page__main-bg explore-bg"
          loading="lazy"
          decoding="async"
        />
      </div>
      ...
      <style jsx>{`
        ...
        .search-bar {
          ...
          background: rgba(
            ...
            255,
            0.08
          ); /* More translucent/brighter than flat dark */
