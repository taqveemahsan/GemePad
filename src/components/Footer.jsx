...
// Using direct import which Vite handles well
import footerBgImg from '../assets/Component_Bg.png'
import poweredByImg from '../assets/PoweredBySonicEngine.png'

export default function Footer() {
  return (
    <footer className="footer-section" style={{ backgroundImage: `url("${footerBgImg}")` }}>
      <div className="footer-inner">
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">© 2010-{new Date().getFullYear()} GemePadFun. All rights reserved</p>
          <div className="footer__powered">
            <img src={poweredByImg} alt="Sonic AI Engine" className="powered-logo" />
          </div>
